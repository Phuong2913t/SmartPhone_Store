window.onload = function () {
	...
	addBanner("img/banners/banner0.gif", "img/banners/banner0.gif");  //tạo vòng lặp điểm đầu là ảnh 0, điểm cuối là ảnh 9 nhg ở đây là ảnh ko tức là vòng lặp vô hạn
...
var filtersFromUrl = { // Các bộ lọc tìm được trên url sẽ đc lưu vào đây
	...
	sort: {
		by: '',
		type: 'ascending'   //ascending: tăng dần
	}
}
